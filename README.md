...
> This template uses `@morse-bot` as the package scope throughout the monorepo.
...
pnpm --filter @morse-bot/auth generate
```
...
3. Outputs a Drizzle-compatible schema file to the `@morse-bot/db` package
