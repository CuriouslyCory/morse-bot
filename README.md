...
> This template uses `@moris-bot` as the package scope throughout the monorepo.
...
pnpm --filter @moris-bot/auth generate
```
...
3. Outputs a Drizzle-compatible schema file to the `@moris-bot/db` package
